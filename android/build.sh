...
if [[ $BUILD_TOOLS_VERSION -ge 2801 ]]; then
  $BUILD_TOOLS/d8 --classpath $SDK/platforms/android-$API_VERSION/android.jar --output $BUILD/dex $BUILD/classes/com/raylib/$NAME/*.class
else
